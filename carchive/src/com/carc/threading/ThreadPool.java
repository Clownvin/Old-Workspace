package com.carc.threading;

import com.carc.util.CyclicArrayList;
...
public final class ThreadPool extends Thread {
	...
	public static boolean addTask(ThreadTask task) {
		try {
			...
			return true;
		} catch (com.carc.util.MaximumCapacityReachedException e) {
			System.out.println("[ThreadPool] Caught MaximumCapacityReached exception for task queue.");
		}
		return false;
	}
